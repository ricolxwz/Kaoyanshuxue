...
\begin{tcolorbox}
\textbf{函数$ $ n $ $阶可导只能用到$ n-1 $次洛必达法则}:  $ n $阶可导无法$ \Rightarrow $ $ n $阶导数连续或是$ n $阶导数在某点的极限存在, 但是可以$ \Rightarrow $ $ n-1 $阶导数是连续的. 如果$ n $阶连续可导则可以$ \Rightarrow $ $ n $阶导数连续或是$ n $阶导数在某点的极限存在.
\end{tcolorbox}
\subsection{微分的定义}
...
\subsection{连续, 可导的关系}
可导$ \Rightarrow $连续, 连续无法$ \Rightarrow $可导.
\begin{tcolorbox}
$ n $阶可导$ \Rightarrow 0\sim n-1 $阶导函数连续, 无法$ \Rightarrow n $阶导函数连续(存在)\par
